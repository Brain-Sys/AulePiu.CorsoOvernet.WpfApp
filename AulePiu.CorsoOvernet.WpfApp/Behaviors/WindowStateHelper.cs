            ...
            try
            {
                ...
                if (File.Exists(fullfilename))
                {
                    ...
                    if (content != "Maximized")
                    {
                        ...
                        int top = Int32.Parse(position[0]);
                        int left = Int32.Parse(position[1]);
                        int width = Int32.Parse(position[2]);
                        int height = Int32.Parse(position[3]);
